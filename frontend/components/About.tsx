export default function About() {
  const problems = [
    ...
    "Outdated, legacy legacy business software architecture"
  ];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start mb-16">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            <div className="p-6 rounded-2xl bg-brand-bg border border-slate-100 shadow-sm">
              <span className="text-2xl mb-3 block">🎯</span>
              <h4 className="text-lg font-bold text-brand-navy mb-2">Our Mission</h4>
              <p className="text-sm text-brand-text leading-relaxed">
                To help businesses modernize their operations using scalable software, automation systems, and intelligent digital solutions. [cite: 121]
              </p>
            </div>
            <div className="p-6 rounded-2xl bg-brand-bg border border-slate-100 shadow-sm">
              ...
              <p className="text-sm text-brand-text leading-relaxed">
                To become one of Africa's leading software outsourcing and business automation companies. [cite: 123]
              </p>
            </div>
          </div>
